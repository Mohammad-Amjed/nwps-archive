    ...
    return (
        <div>
            <h2>Popular Post</h2>
                         ...
                         <PostContect img={require("./assets/popular-post/m-blog-3.jpg")}  Admin={"Admin"} Date={"January 14, 2019"} CommentsNo={"2"} Title={"New data recording system to better analyse road accidents"}   />
                         ...
                         <PostContect img={require("./assets/popular-post/m-blog-5.jpg")}  Admin={"Admin"} Date={"January 14, 2019"} CommentsNo={"2"} Title={"New data recording system to better analyse road accidents"}   />
        </div>
    )
}
